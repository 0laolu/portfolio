...
export default function AboutContent() {
    return(
        <div className="w-1/2">
            ...
            <div className="">
                <button className="w-7/20 border border-gray-400 py-4 rounded-4xl font-semibold cursor-pointer" type="button">Let's work together</button>
            </div>
        </div>
    )
}
