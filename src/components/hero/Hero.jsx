    ...
    return(
        <section className=" w-93/100 mx-auto my-8 lg:mx-0">
            <div className="w-full xl:max-w-[1300px] mx-auto">
                ...
                <p className="my-6 text-[var(--color-muted)] font-semibold text-[1.1rem] max-w-[712px] mx-auto font-body tracking-normal lg:text-lg lg:max-w-[1100px] lg:mx-0">Focused on speed, user experience, and results that grow your business. Let's build a digital presence that propels your brand forward!</p>
...
<div className="bullet-point-container flex flex-col gap-2 ">
                ...
                <div className=" mt-8 max-w-[605px] sm:flex sm:justify-between lg:max-w-[550px]">
                    <button className="w-full max-w-[400px] btn-primary grad-bg py-4 mb-3 font-semibold cursor-pointer sm:mr-0 sm:mb-0 lg:w-9/10 lg:max-w-[240px] lg:text-lg  lg:mb-0" type="button">See It in Action</button>
                    <button className="w-full max-w-[400px]  btn-ghost py-4 font-semibold cursor-pointer lg:text-lg lg:max-w-[280px]" type="button">Let's Build Your Website</button>
                </div>

                <div className="social-proof mt-8 ">
                    <p className="text-[var(--color-muted)] font-semibold font-body lg:text-[1.2rem]">Built real-world, production-ready websites for businesses and growing startups.</p>
                </div>
