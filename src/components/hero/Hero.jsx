        ...
        <section className=" w-93/100 mx-auto my-8 lg:mx-0">
            <div className="w-full xl:max-w-[1300px] mx-auto">
                ...
                <motion.div 
                    ...
                    className="badge mb-8 mx-auto lg:mx-0 w-fit"
                >
                ...
                <motion.h1 
                    ...
                    className="text-[var(--color-cream)] text-[1.9rem]/10 max-w-[640px] mx-auto lg:text-5xl/15 lg:max-w-none lg:mx-0 font-bold"
                >
                ...
                <motion.p 
                    ...
                    className="my-6 text-[var(--color-muted)] font-base text-[1.1rem] max-w-[712px] mx-auto font-body tracking-normal lg:text-lg lg:max-w-[1100px] lg:mx-0"
                >
                    Focused on speed, user experience, and results that grow your business. Let's build a digital presence that propels your brand forward!
                </motion.p>
                ...
                <motion.div 
                    ...
                    className="bullet-point-container flex flex-col gap-2 "
                >
                ...
                <motion.div 
                    ...
                    className=" mt-8 max-w-[605px] sm:flex sm:justify-between lg:max-w-[550px]"
                >
                ...
                <motion.ul 
                    ...
                    className="w-4/5 max-w-[250px] mt-13 flex justify-between lg:w-7/25 lg:max-w-[250px]"
                >
                    <li>
                ...
                <motion.div 
                    ...
                    className="glow-line w-full mt-16 mx-auto"
                ></motion.div>
            </div>
        </section>
    )
